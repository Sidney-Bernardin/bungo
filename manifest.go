...
type MobileWorldContentPaths struct {
	En    string `json:"en"`
	Fr    string `json:"fr"`
	Es    string `json:"es"`
...
type JSONWorldContentPaths struct {
	En    string `json:"en"`
	Fr    string `json:"fr"`
	Es    string `json:"es"`
	EsMx  string `json:"es-mx"`
...
type JSONWorldComponentContentPaths struct {
	En    En    `json:"en"`
	Fr    Fr    `json:"fr"`
	Es    Es    `json:"es"`
	EsMx  EsMx  `json:"es-mx"`
	De    De    `json:"de"`
	It    It    `json:"it"`
	Ja    Ja    `json:"ja"`
	PtBr  PtBr  `json:"pt-br"`
	Ru    Ru    `json:"ru"`
	Pl    Pl    `json:"pl"`
	Ko    Ko    `json:"ko"`
	ZhCht ZhCht `json:"zh-cht"`
	ZhChs ZhChs `json:"zh-chs"`
}
type MobileGearCDN struct {
